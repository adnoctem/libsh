...
# Globals: None
# Arguments: needle, followed by zero or more elements
...
# Outputs: Normalized integer on stdout, no diagnostics.
# Returns: 0 valid, 2 invalid/out of range.
#######################################
...
# Globals: None
# Arguments: B, KB..EB, or KiB..EiB
# Outputs: Integer multiplier on stdout.
# Returns: 0 recognized, 2 unknown.
#######################################
function __libsh_data_byte_factor() {
  case ${1:-} in
  B) printf 1 ;; KB) printf 1000 ;; MB) printf 1000000 ;;
  GB) printf 1000000000 ;; TB) printf 1000000000000 ;;
  PB) printf 1000000000000000 ;; EB) printf 1000000000000000000 ;;
  KiB) printf 1024 ;; MiB) printf 1048576 ;; GiB) printf 1073741824 ;;
  TiB) printf 1099511627776 ;; PiB) printf 1125899906842624 ;;
  EiB) printf 1152921504606846976 ;; *) return 2 ;;
  esac
}
...
# Globals: None
# Arguments: AMOUNT UNIT (B, KB..EB or KiB..EiB; case sensitive)
...
# Globals: None
# Arguments: bytes, positive unit multiplier, precision (0..6)
# Outputs: Decimal number on stdout, without newline or unit label.
# Returns: 0 success.
#######################################
...
# Globals: None
# Arguments: BYTES UNIT [PRECISION=2], precision 0..6
...
# Globals: None
# Arguments: BYTES [SYSTEM=iec (iec|si)] [PRECISION=2 (0..6)]
