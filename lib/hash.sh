...
# Exact string checksums using installed GNU or macOS hashing tools.
...
#   PATH (read)
# Arguments:
#   1 - Algorithm: md5, 224, 256, 384 or 512
#   2 - String to hash
# Outputs:
#   Lowercase hexadecimal digest and newline; errors on stderr.
# Returns:
#   0 success, 1 missing/failed backend or malformed output.
#######################################
...
#   Lowercase hexadecimal digest and newline; errors on stderr.
# Returns:
#   0 success, 1 backend failure, 2 incorrect argument count.
# Dependencies:
#   md5sum (GNU) or md5 (macOS), checked at invocation.
#######################################
...
#   Lowercase hexadecimal digest and newline; errors on stderr.
# Returns:
#   0 success, 1 backend failure, 2 invalid invocation.
# Dependencies:
#   sha*sum (GNU) or shasum (macOS), checked at invocation.
#######################################
